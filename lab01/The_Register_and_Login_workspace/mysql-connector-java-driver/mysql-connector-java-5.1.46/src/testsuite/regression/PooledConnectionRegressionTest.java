 ...
 * This gives the application server a way to take a connection away from a Client.client. This is an unlikely scenario but may be useful if the application server is
