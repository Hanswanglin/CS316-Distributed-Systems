 ...
 * return it to the application Client.client in response to dataSource.getConnection().
 * 
 ...
 * 
 * All sqlExceptions thrown by the physical connection are intercepted and sent to connectionEvent listeners before being thrown to Client.client.
 */
public class ConnectionWrapper extends WrapperBase implements Connection {
     ...
     * of any caught exceptions before re-throwing to Client.client.
     * 
    ...
    protected void close(boolean fireClosedEvent) throws SQLException {
        synchronized (this.pooledConnection) {
            ...
            // set closed status to true so that if application Client.client tries to make additional calls a sqlException will be thrown. The physical connection is
