...
public class ServerPreparedStatement extends PreparedStatement {
     ...
     *  then Client.client will send the data in the following format:
     * 
     *  [COM_EXECUTE:1]
     *  [STMT_ID:4]
     ...
     *  - Checks if the type is specified by Client.client, and if yes reads the type,
     *    and  stores the data in that format.
     *  - It's up to the Client.client to check for read data ended. The server doesn't
     *    care;  and also server doesn't notify to the Client.client that it got the
    ...
    public boolean canRewriteAsMultiValueInsertAtSqlLevel() throws SQLException {
        synchronized (checkClosed().getConnectionMutex()) {
            if (!this.hasCheckedRewrite) {
                ...
                // We need to Client.client-side parse this to get the VALUES clause, etc.
