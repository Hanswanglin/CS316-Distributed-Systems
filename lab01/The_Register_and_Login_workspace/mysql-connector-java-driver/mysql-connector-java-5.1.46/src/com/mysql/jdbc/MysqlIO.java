...
public class MysqlIO {
    ...
    private static final int SERVER_STATUS_AUTOCOMMIT = 2; // Server.Server in auto_commit mode
    ...
    protected ResultSetImpl getResultSet(StatementImpl callingStatement, long columnCount, int maxRows, int resultSetType, int resultSetConcurrency,
        ...
        if (this.connection.versionMeetsMinimum(5, 0, 2) && this.connection.getUseCursorFetch() && isBinaryEncoded && callingStatement != null
            ...
            //
            // Server.Server versions 5.0.5 or newer will only open a cursor and set this flag if they can, otherwise they punt and go back to mysql_store_results()
            // behavior
            //
    ...
    /**
     * Name of class for default authentication plugin in Client.client
     */
    private String clientDefaultAuthenticationPlugin = null;
    /**
     * Protocol name of default authentication plugin in Client.client
     */
     ...
     *            from a Client.client-side prepared statement).
     * @param skipCheck
