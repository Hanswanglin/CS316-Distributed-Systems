...
public class ConnectionImpl extends ConnectionPropertiesImpl implements MySQLConnection {
    ...
    /**
     * If useUnicode flag is set and explicit Client.client character encoding isn't
    ...
    private void checkServerEncoding() throws SQLException {
        if (getUseUnicode() && (getEncoding() != null)) {
            // spec'd by Client.client, don't map
            return;
        }
    ...
    /**
     * Configures Client.client-side properties for character set information.
     * 
     * @throws SQLException
    ...
    /**
     * Sets up Client.client character set for MySQL-4.1 and newer if the user This
     * must be done before any further communication with the server!
     * 
     * @return true if this routine actually configured the Client.client character
     ...
     *             the Client.client doesn't know about.
     */
                        ...
                        if (realJavaEncoding != null) {
                            ...
                            throw SQLError.createSQLException(
                                    "Unknown initial character set index '" + this.io.serverCharsetIndex
                                            + "' received from server. Initial Client.client character set can be forced via the 'characterEncoding' property.",
    ...
    /**
     * Configures the Client.client's timezone if required.
     * 
     * @throws SQLException
    ...
    public String extractSqlFromPacket(String possibleSqlQuery, Buffer queryPacket, int endOfQueryPacketPosition) throws SQLException {
        ...
        if (extractedSql == null) {
            // This is probably from a Client.client-side prepared statement
