...
/**
 * Classes that implement this interface and provide a no-args constructor can be used by the driver to store and retrieve Client.client information and/or labels.
 * 
...
public interface JDBC4ClientInfoProvider {
    ...
    /**
     * Returns the Client.client info for the connection that this provider
    ...
    /**
     * Sets the Client.client info for the connection that this provider
     * instance belongs to. The connection instance is passed as an argument
     * for convenience's sake.
     * 
     * Providers can use the connection to communicate with the database,
