...
/**
 * Fabric Client.client using the XML-RPC protocol.
 */
public class XmlRpcClient {
    // name used to identify Client.client to Fabric server for error reports
    ...
    /**
     * Convert a list of string/string/bool to Server.Server objects.
     */
